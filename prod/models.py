...
class Prod(models.Model):
    ...
    boulanger = models.CharField(max_length=100, default="", null="", choices=boulanger_list)
...
class Data(models.Model):
    ...
    @property
    def total(self):
        return self.T80 + self.BuchNat + self.BuchMG + self.BuchRN + self.BuchNoix + self.RizSar + self.PetEp + self.Brioche
    ...
    def non_zero(self):
        ...
        non_zero_items = [element for element in non_zero_items if element not in to_remove]
        return non_zero_items
    
    def types_de_pains(self):
        return ["T80","BuchNat","BuchMG","BuchRN","BuchNoix","RizSar","PetEp","Brioche","Cookies"]
